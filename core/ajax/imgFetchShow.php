...
if(isset($_POST['fetchImgInfo'])){
	...
	$main_react = $loadFromPost->main_react($userid, $postid);
            ...
            ?>
<div class="top-wrap">
	<div class="post-img-wrap" style="display: flex; background-color: white; width: 7-%; justify-content: center; align-items: center; height: 100vh;">
		<div class="post-img-action" style="background-color:#0000008c; height: 100%; aligh-items: center; display: flex;">
...
$blockedUserComment = $loadFromPost->block($comment->commentBy, $userid);
            ...
            ?>
                 ...
                 foreach($replyDetails as $reply){
                     $blockedUserReply = $loadFromPost->block($reply->commentBy, $userid);
