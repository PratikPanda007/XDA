...
<div class="overview-wrap" style="">
	<div class="overview-left">
		...
		<div class="contact-id" style="width: 100%;display:flex; ">
			<div class="contact-id-text setting" style="flex-basis:40%">XDA Link</div>
			<div class="contact-id-number setting" style="flex-basis:60%"><a href="<?php echo ''.BASE_URL.''.$userdata->userLink;?>" target="_blank"><?php echo $userdata->userLink;?></a></div>
		</div>
		<br><br>
